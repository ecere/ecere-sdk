...
class IDEWorkSpace : Window
{
   ...
   Menu windowMenu { menu, $"Window", w };
      ...
      MenuItem { windowMenu, $"Next", n, Key { right, alt = true }, NotifySelect = MenuWindowNext };
      MenuItem { windowMenu, $"Previous", p, Key { left, alt = true }, NotifySelect = MenuWindowPrevious };
      MenuDivider { windowMenu };
