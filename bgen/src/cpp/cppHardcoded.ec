...
void cppHardcodedInstancePart1(BOutput o)
{
   o.z.concatx("   // hardcoded content start", ln,
               ...
               "   void (**vTbl)(void);", ln,
               "", ln);
   o.z.concatx("   void * operator new   (uintsize count) { return eC_new(count); }", ln,
