...
else if(!n->incoming || !((struct __ecereNameSpace__ecere__com__LinkList *)(((char *)n->incoming + 0 + sizeof(struct __ecereNameSpace__ecere__com__Instance))))->count)
{
__ecereMethod___ecereNameSpace__ecere__sys__OldList_Remove((&*input), n);
...
{
next = c->next;
if(!c->incoming || !((struct __ecereNameSpace__ecere__com__LinkList *)(((char *)c->incoming + 0 + sizeof(struct __ecereNameSpace__ecere__com__Instance))))->count)
{
