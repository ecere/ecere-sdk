...
yyn += yytoken;
if(yyn < 0 || 8658 < yyn || yycheck[yyn] != yytoken)
goto yydefault;
yyn = yytable[yyn];
if(yyn <= 0)
{
...
if(0 <= yystate && yystate <= 8658 && yycheck[yystate] == *yyssp)
...
{
yyn += 1;
if(0 <= yyn && yyn <= 8658 && yycheck[yyn] == (short)1)
{
yyn = yytable[yyn];
if(0 < yyn)
break;
