...
yyn += yytoken;
if(yyn < 0 || 6639 < yyn || yycheck[yyn] != yytoken)
goto yydefault;
yyn = yytable[yyn];
if(yyn <= 0)
{
...
if(0 <= yystate && yystate <= 6639 && yycheck[yystate] == *yyssp)
...
{
yyn += 1;
if(0 <= yyn && yyn <= 6639 && yycheck[yyn] == (short)1)
{
yyn = yytable[yyn];
if(0 < yyn)
break;
