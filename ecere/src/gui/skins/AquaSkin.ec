...
BitmapResource bmpUpMiddle { "<:ecere>aqua/upMiddle.png", alphaBlend = true };
BitmapResource bmpUpLeft { "<:ecere>aqua/upLeft.png", alphaBlend = true };
BitmapResource bmpUpRight { "<:ecere>aqua/upRight.png", alphaBlend = true };

BitmapResource bmpDownMiddle { "<:ecere>aqua/downMiddle.png", alphaBlend = true };
BitmapResource bmpDownLeft { "<:ecere>aqua/downLeft.png", alphaBlend = true };
BitmapResource bmpDownRight { "<:ecere>aqua/downRight.png", alphaBlend = true };

BitmapResource bmpScrollUp { "<:ecere>aqua/scrollUp.png", alphaBlend = true };
BitmapResource bmpScrollDown { "<:ecere>aqua/scrollDown.png", alphaBlend = true };
BitmapResource bmpScrollVert { "<:ecere>aqua/scrollVert.png", alphaBlend = true };

BitmapResource bmpThumbUp { "<:ecere>aqua/thumbUp.png", alphaBlend = true };
BitmapResource bmpThumbDown { "<:ecere>aqua/thumbDown.png", alphaBlend = true };
BitmapResource bmpThumbVert { "<:ecere>aqua/thumbVert.png", alphaBlend = true };

BitmapResource bmpLeftBorder { "<:ecere>aqua/leftBorder.png", alphaBlend = true };
BitmapResource bmpRightBorder { "<:ecere>aqua/rightBorder.png", alphaBlend = true };
BitmapResource bmpTopBorder { "<:ecere>aqua/topBorder.png", alphaBlend = true };
BitmapResource bmpBottomBorder { "<:ecere>aqua/bottomBorder.png", alphaBlend = true };

BitmapResource bmpTopLeftBorder { "<:ecere>aqua/topLeftBorder.png", alphaBlend = true };
BitmapResource bmpTopRightBorder { "<:ecere>aqua/topRightBorder.png", alphaBlend = true };
BitmapResource bmpBottomLeftBorder { "<:ecere>aqua/bottomLeftBorder.png", alphaBlend = true };
BitmapResource bmpBottomRightBorder { "<:ecere>aqua/bottomRightBorder.png", alphaBlend = true };
...
public class AquaSkin_ScrollBar : ScrollBar
{
   ...
   bool OnPostCreate()
   {
      ...
      if(sbStyle.vertical)
      {
         ...
         downBtn.bitmap = { fileName = "<:ecere>aqua/scrollDown.png", alphaBlend = true };

         upBtn.bevel = false;
         upBtn.size.h = 18;
         upBtn.anchor = Anchor { left = 0, right = 0, bottom = 0 };
         upBtn.bitmap = { fileName = "<:ecere>aqua/scrollUp.png", alphaBlend = true };
...
public class AquaSkin_Button : Button
{
...
public class AquaSkin_Window : Window
{
   bool OnPostCreate()
   {
   ...
   void UpdateNonClient()
   {
      ...
      if(sysButtons[0])
      {
         sysButtons[0].anchor = { right = 43 + border, top = top + BUTTON_OFFSET };
      ...
      if(sysButtons[1])
      {
         sysButtons[1].anchor = { right = 28 + border, top = top + BUTTON_OFFSET };
      ...
      if(sysButtons[2])
      {
         sysButtons[2].anchor = { right = 10 + border, top = top + BUTTON_OFFSET };
   ...
   bool IsOpaque()
   {
      return (!style.drawBehind && opacity == 1.0) && !((BorderBits)borderStyle).fixed;
   }
}
#else
import "instance"
