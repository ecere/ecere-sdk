...
hlp:
	...
	@$(info $(_mkcmd_example) help-bindings                                 -- generating and building bindings)
...
# 	@$(info $(_mkcmd_example) bindingsgen                                   -- x. )
	@$(info $(_mkcmd_example) bindings_gen                                  -- x. )
	@$(info $(_mkcmd_example) bindings_build                                -- x. )
	@$(info $(_mkcmd_example) bindings_clean                                -- x. )
#	@$(info $(_mkcmd_example) bindings_cleantarget                          -- x. )
#	@$(info $(_mkcmd_example) bindings_realclean                            -- x. )
#	@$(info $(_mkcmd_example) bindings_wipeclean                            -- x. )
#	@$(info $(_mkcmd_example) bindings_distclean                            -- x. )
	@$(info )
	@$(info C bindings:)
	@$(info )
	@$(info $(_mkcmd_example) c_bindings                                    -- x. )
	@$(info $(_mkcmd_example) c_bindings_gen                                -- x. )
	@$(info $(_mkcmd_example) c_bindings_build                              -- x. )
#	@$(info $(_mkcmd_example) bindingstestc                                 -- x. )
	@$(info $(_mkcmd_example) c_bindings_clean                              -- x. )
#	@$(info $(_mkcmd_example) c_bindings_cleantarget                        -- x. )
#	@$(info $(_mkcmd_example) c_bindings_realclean                          -- x. )
#	@$(info $(_mkcmd_example) c_bindings_wipeclean                          -- x. )
	@$(info )
	@$(info C++ bindings:)
	@$(info )
	@$(info $(_mkcmd_example) cxx_bindings                                  -- x. )
	@$(info $(_mkcmd_example) cxx_bindings_gen                              -- x. )
	@$(info $(_mkcmd_example) cxx_bindings_build                            -- x. )
	@$(info $(_mkcmd_example) cxx_bindings_clean                            -- x. )
#	@$(info $(_mkcmd_example) cxx_bindings_cleantarget                      -- x. )
#	@$(info $(_mkcmd_example) cxx_bindings_realclean                        -- x. )
#	@$(info $(_mkcmd_example) cxx_bindings_wipeclean                        -- x. )
	@$(info )
	@$(info Python bindings:)
	@$(info )
	@$(info $(_mkcmd_example) py_bindings                                   -- x. )
	@$(info $(_mkcmd_example) py_bindings_gen                               -- x. )
	@$(info $(_mkcmd_example) py_bindings_build                             -- x. )
	@$(info $(_mkcmd_example) py_bindings_clean                             -- x. )
#	@$(info $(_mkcmd_example) py_bindings_cleantarget                       -- x. )
#	@$(info $(_mkcmd_example) py_bindings_realclean                         -- x. )
